...
Page({
  ...
  buildingids:[
    ...
    [{ 'id': '207', 'name': '天山堂' }, { 'id': '1364', 'name': '贺兰堂' }, { 'id': '2165', 'name': '宏远楼' }, { 'id': '2066', 'name': '昆仑堂' }, { 'id': '119', 'name': '气象楼' }, { 'id': '332', 'name': '实践' }, { 'id': '133', 'name': '实验楼' }, { 'id': '1144', 'name': '闻韶楼' }, { 'id': '334', 'name': '西区教学楼' }, { 'id': '121', 'name': '新闻楼' }, { 'id': '366', 'name': '艺术楼' }, { 'id': '1354', 'name': '（榆中）核学院38号楼' }, { 'id': '2613', 'name': '（榆中）南区多功能环境风洞实验室' }, { 'id': '1355', 'name': '（榆中）室外-校园内' }, { 'id': '1356', 'name': '（榆中）室外-校园外' }, { 'id': '1357', 'name': '（榆中）西区草科院实验楼' }, { 'id': '1358', 'name': '（榆中）西区草科院试验站' }, { 'id': '1359', 'name': '（榆中）西区观测场' }, { 'id': '1360', 'name': '（榆中）西区教学楼' }, { 'id': '1361', 'name': '（榆中）西区人体解剖实验室' }, { 'id': '1362', 'name': '（榆中）小礼堂' }, { 'id': '2424', 'name': '办公楼' }, { 'id': '1363', 'name': '高远楼' }, { 'id': '2224', 'name': '工程实验中心' }, { 'id': '2071', 'name': '榆中23号学生公寓' }, { 'id': '2404', 'name': '榆中网 络中心' }, { 'id': '326', 'name': '运动场' }],
    ...
    placeArray: [['榆中校区', '盘旋路校区', '医学校区', '护理学院'], ['天山堂', '贺兰堂', '宏远楼', '昆仑堂', '气象楼', '实践', '实验楼', '闻韶楼', '西区教学楼', '新闻楼', '艺术楼', '（榆中）核学院38号楼', '（榆中）南区多功能环境风洞实验室', '（榆中）室外-校园内', '（榆中）室外-校园外', '（榆中）西区草科院实验楼', '（榆中）西区草科院试验站', '（榆中）西区观测场', '（榆中）西区教学楼', '（榆中）西区人体解剖实验室', '（榆中）小礼堂', '办公楼', '高远楼', '工程实验中心', '榆中23号学生公寓', '榆中网络中心', '运动场']],
    
    subplaceArray: [
      ['天山堂', '贺兰堂', '宏远楼', '昆仑堂', '气象楼', '实践', '实验楼', '闻韶楼', '西区教学楼', '新闻楼', '艺术楼', '（榆中）核学院38号楼', '（榆中）南区多功能环境风洞实验室', '（榆中）室外-校园内', '（榆中）室外-校园外', '（榆中）西区草科院实验楼', '（榆中）西区草科院试验站', '（榆中）西区观测场', '（榆中）西区教学楼', '（榆中）西区人体解剖实验室', '（榆中）小礼堂', '办公楼', '高远楼', '工程实验中心', '榆中23号学生公寓', '榆中网络中心', '运动场'],
  ...
  onLoad: function (options) {
    ...
    this.setData({
      'weekIndex': app.globalData.defaultValue - 1
    })
  },
